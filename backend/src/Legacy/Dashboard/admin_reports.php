    ...
    <main class="max-w-7xl mx-auto p-4 md:p-8">
        ...
        <div class="bg-white rounded-xl shadow p-4 mb-6">
            ...
            <div class="flex flex-wrap gap-2">
                <a href="admin_reports.php?<?= htmlspecialchars(http_build_query(['year' => $selectedYear, 'export' => 'projects_csv'])) ?>"
                ...
                <a href="admin_reports.php?<?= htmlspecialchars(http_build_query(['year' => $selectedYear, 'export' => 'pending_tasks_csv'])) ?>"
        ...
        <div class="bg-white rounded-xl shadow overflow-hidden mb-6">
            ...
            <?php if ($projectTotal > 0): ?>
                <?php
                    ...
                    $projectQuery = ['year' => $selectedYear, 'pending_page' => $pendingPage];
                ?>
        ...
        <div class="bg-white rounded-xl shadow overflow-hidden">
            ...
            <?php if ($pendingTotal > 0): ?>
                <?php
                    ...
                    $pendingQuery = ['year' => $selectedYear, 'project_page' => $projectPage];
                ?>
                <div class="px-4 py-3 border-t bg-white flex flex-col md:flex-row md:items-center md:justify-between gap-3">
